...
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(922337203685477600);
...
const char     CRYPTONOTE_NAME[]                             = "kaiser";
...
const int      P2P_DEFAULT_PORT                              =  10667;
const int      RPC_DEFAULT_PORT                              =  11667;
...
const char* const SEED_NODES[] = { "159.65.93.242:10667", "159.65.93.249:10667" };
